...
export type WebAppShape = TLBaseShape<
  'web-app',
  {
    w: number
    h: number
...
export class WebAppShapeUtil extends BaseBoxShapeUtil<WebAppShape> {
  static override type = 'web-app' as const

  static override props: RecordProps<WebAppShape> = {
    w: T.number,
    h: T.number,
    color: T.string,
  ...
  override getDefaultProps(): WebAppShape['props'] {
    return {
      w: 120,
      h: 100,
      color: 'black',
  ...
  override component(shape: WebAppShape) {
  ...
  override indicator(shape: WebAppShape) {
    const { w, h } = shape.props
