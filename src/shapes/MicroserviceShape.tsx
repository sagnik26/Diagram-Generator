...
export class MicroserviceShapeUtil extends BaseBoxShapeUtil<MicroserviceShape> {
  static override type = 'microservice' as const

  static override props: RecordProps<MicroserviceShape> = {
    w: T.number,
    h: T.number,
    color: T.string,
  ...
  override getDefaultProps(): MicroserviceShape['props'] {
    return {
      w: 140,
      h: 80,
      color: 'black',
  ...
  override component(shape: MicroserviceShape) {
  ...
  override indicator(shape: MicroserviceShape) {
    const { w, h } = shape.props
