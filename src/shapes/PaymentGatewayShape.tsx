...
export type PaymentGatewayShape = TLBaseShape<
  'payment-gateway',
  {
    w: number
    h: number
...
export class PaymentGatewayShapeUtil extends BaseBoxShapeUtil<PaymentGatewayShape> {
  static override type = 'payment-gateway' as const

  static override props: RecordProps<PaymentGatewayShape> = {
    w: T.number,
    h: T.number,
    color: T.string,
  ...
  override getDefaultProps(): PaymentGatewayShape['props'] {
    return {
      w: 140,
      h: 80,
      color: 'black',
  ...
  override component(shape: PaymentGatewayShape) {
  ...
  override indicator(shape: PaymentGatewayShape) {
    const { w, h } = shape.props
