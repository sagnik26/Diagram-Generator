...
export class MessageQueueShapeUtil extends BaseBoxShapeUtil<MessageQueueShape> {
  static override type = 'message-queue' as const

  static override props: RecordProps<MessageQueueShape> = {
    w: T.number,
    h: T.number,
    color: T.string,
  ...
  override getDefaultProps(): MessageQueueShape['props'] {
    return {
      w: 140,
      h: 80,
      color: 'black',
  ...
  override component(shape: MessageQueueShape) {
  ...
  override indicator(shape: MessageQueueShape) {
    const { w, h } = shape.props
