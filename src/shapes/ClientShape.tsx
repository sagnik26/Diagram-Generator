...
export class ClientShapeUtil extends BaseBoxShapeUtil<ClientShape> {
  ...
  override getDefaultProps(): ClientShape['props'] {
    return {
      w: 100,
      h: 100,
      color: 'black',
  ...
  override component(shape: ClientShape) {
  ...
  override indicator(shape: ClientShape) {
    const { w, h } = shape.props
    // Ellipse indicator
    const rx = w / 2
    const ry = h / 2
